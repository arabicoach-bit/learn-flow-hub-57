...
import { BarChart3, Calendar, Clock, Users, BookOpen, TrendingUp } from 'lucide-react';
...
export default function TeacherQuarterPerformance() {
  ...
  // Find the teacher's data from the quarter analysis
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Your monthly performance breakdown</p>
          </div>
        ...
        <Badge variant="outline" className="text-sm px-3 py-1">
          ...
          <span className="ml-2 text-muted-foreground">{currentQuarter.startDate} → {currentQuarter.endDate}</span>
        </Badge>
                ...
                <div className="overflow-x-auto">
                  <Table>
                    ...
                    <TableBody>
                      ...
                      <TableRow className="font-bold bg-emerald-500/5">
